...
$.fn.window.defaults = $.extend({}, $.fn.panel.defaults, { zIndex: 22891014, draggable: true, resizable: true, shadow: true, modal: false, inline: false, title: "New Window", collapsible: true, minimizable: true, maximizable: true, closable: true, closed: false });
})(jQuery);
(function($){
function _28f(_290){
...
if (opts.maxlength != null) {//新增属性，判断长度
    if (s.length > opts.maxlength-1) { return false; }
}
...
}},{ text: function (_a0g) { return $(_a0g).datebox("options").cleanText; }, handler: function (_a0h) { $(_a0h).combo('setValue', '').combo('setText', ''); $(this).closest("div.combo-panel").panel("close"); } }], formatter: function (date) {
